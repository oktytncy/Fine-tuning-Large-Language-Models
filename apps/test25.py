...
# you can improve the appearance of your DataFrame output even in Visual Studio’s terminal. 
# while Jupyter renders the styled DataFrame as an HTML table, in a plain terminal you can use libraries like Rich to create a more visually appealing table.
